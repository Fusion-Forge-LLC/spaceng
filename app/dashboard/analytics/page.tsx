...
function Page() {
  return (
    <div className="px-3 text-grey-200 space-y-8 pb-4">
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-12 gap-5">
          <div className="space-y-5 col-span-3 pt-3">
          ...
          <div className="space-y-5 col-span-4 pt-3">
          ...
          <div className="p-3 rounded-xl border pb-0 border-blue col-span-5">
