    ...
    <>
      <article>
        <Wrapper className="pb-28 pt-6 sm:pt-20">
          <h3 className="text-lg font-medium mb-5 md:mb-14">About SpacesNG Technologies Limited</h3>
          <p className="leading-[2.3]">
            ...
            affordable workspaces, empowering them to focus on growth and success. Our mission is to
            bridge the gap between businesses and suitable workspaces, reducing the stress and
            ...
            users. We believe that by working together, we can create a more productive, connected,
          ...
          <ul className="grid grid-cols-1 md:grid-cols-3 gap-y-16 md:gap-4 lg:gap-16">
            <MissionCards title="Mission">
              <p className="mt-auto text-sm leading-relaxed mb-auto">
                Empower individuals, teams, and organizations to thrive in an ever-evolving world by
                forging innovative solutions, spaces, and experiences that meet their changing needs
              </p>
            </MissionCards>
