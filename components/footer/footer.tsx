        ...
        <div className=" md:flex gap-20">
          <article className="space-y-4 md:w-1/3 lg:w-2/5 mb-16 md:mb-0">
            ...
            <div className="flex gap-3 py-3">
              ...
              <Link
                className="bg-white grid h-7 w-7 rounded-full place-content-center"
                href={"https://www.youtube.com/@spacefindatechnologies"}
              >
                <svg
              ...
              <Link
                className="bg-white grid h-7 w-7 rounded-full place-content-center"
                href={"https://www.tiktok.com/@spacefinda"}
              >
                <svg
                  height="24"
                  version="1.1"
